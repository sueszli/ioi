...
# alternative approach: https://github.com/hyper-neutrino/advent-of-code/blob/main/2023/day08p2.py
# - assumption: you can hit multiple z's until you start looping
# - truth: for some reason, you loop after hitting the first z, therefore the simplified implementation below works (but it isn't generalizable)
...
def get_steps(curr):
    ...
    while not curr.endswith("Z"):
        ...
        curr = dic[curr][0 if cmd == "L" else 1]
        steps += 1
